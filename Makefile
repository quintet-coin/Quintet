...
pkgdatadir = $(datadir)/quintet
pkgincludedir = $(includedir)/quintet
pkglibdir = $(libdir)/quintet
pkglibexecdir = $(libexecdir)/quintet
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/qtcoin_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/qtcoin_qt.m4 \
	$(top_srcdir)/build-aux/m4/qtcoin_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/quintet-config.h
CONFIG_CLEAN_FILES = libqtcoinconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libqtcoinconsensus.pc.in \
	...
	$(top_srcdir)/src/config/quintet-config.h.in \
...
ACLOCAL = ${SHELL} /home/jj/coins/quintet/quintet-1.3.1/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/jj/coins/quintet/quintet-1.3.1/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/jj/coins/quintet/quintet-1.3.1/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/jj/coins/quintet/quintet-1.3.1/build-aux/missing automake-1.15
...
MAINT = 
MAKEINFO = ${SHELL} /home/jj/coins/quintet/quintet-1.3.1/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = quintet
PACKAGE_BUGREPORT = www.qtc.org
PACKAGE_NAME = QuinTet Core
PACKAGE_STRING = QuinTet Core 1.3.1
PACKAGE_TARNAME = quintet
PACKAGE_URL = 
...
QTCLIPBOARD_CFLAGS = 
QTCLIPBOARD_LIBS = 
QTCOIN_CLI_NAME = quintet-cli
QTCOIN_DAEMON_NAME = quintetd
QTCOIN_GUI_NAME = quintet-qt
QTCOIN_TX_NAME = quintet-tx
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/jj/coins/quintet/quintet-1.3.1
abs_srcdir = /home/jj/coins/quintet/quintet-1.3.1
abs_top_builddir = /home/jj/coins/quintet/quintet-1.3.1
abs_top_srcdir = /home/jj/coins/quintet/quintet-1.3.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/jj/coins/quintet/quintet-1.3.1/build-aux/install-sh
...
#pkgconfig_DATA = libqtcoinconsensus.pc
QTCOIND_BIN = $(top_builddir)/src/$(QTCOIN_DAEMON_NAME)$(EXEEXT)
QTCOIN_QT_BIN = $(top_builddir)/src/qt/$(QTCOIN_GUI_NAME)$(EXEEXT)
QTCOIN_CLI_BIN = $(top_builddir)/src/$(QTCOIN_CLI_NAME)$(EXEEXT)
QTCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = QuinTet-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/qtcoin.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/quintet-cli.bash-completion \
	       $(top_srcdir)/contrib/quintet-tx.bash-completion \
	       $(top_srcdir)/contrib/quintetd.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/qtcoin.ico \
...
COVERAGE_INFO = baseline.info \
  test_quintet_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_quintet_coverage.info test_quintet.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/qtcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/QuinTet-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
EXTRA_DIST = $(DIST_SHARE) qa/pull-tester/rpc-tests.sh \
	qa/pull-tester/run-qtcoin-cli qa/rpc-tests $(DIST_CONTRIB) \
	$(DIST_DOCS) $(WINDOWS_PACKAGING) $(OSX_PACKAGING) \
	$(BIN_CHECKS) test/util/qtcoin-util-test.py \
	test/util/data/qtcoin-util-test.json \
...
CLEANFILES = $(OSX_DMG) $(QTCOIN_WIN_INSTALLER)
...
src/config/quintet-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/quintet-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/quintet-config.h
$(top_srcdir)/src/config/quintet-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/quintet-config.h src/config/stamp-h1
libqtcoinconsensus.pc: $(top_builddir)/config.status $(srcdir)/libqtcoinconsensus.pc.in
...
$(QTCOIN_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(QTCOIND_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(QTCOIN_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(QTCOIN_CLI_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/qtcoin.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/QuinTet-Qt: all-recursive
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $(QTCOIN_QT_BIN) $@
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/QuinTet-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/QuinTet-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_quintet.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_quintet -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_quintet_filtered.info: test_quintet.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_quintet_filtered.info
...
#test_quintet_coverage.info: baseline_filtered.info test_quintet_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_quintet_filtered.info -o $@

#total_coverage.info: test_quintet_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_quintet_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_quintet.coverage/.dirstamp:  test_quintet_coverage.info
...
#cov: test_quintet.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_quintet.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
