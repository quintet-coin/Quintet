...
#   c) node1 mines 32 blocks, so now node 0 has 500000QTC, node 1 has 4250QTC, node2 has none.
#   d) node0 sends 601 QTC to node2, in two transactions (301 QTC, then 300 QTC).
