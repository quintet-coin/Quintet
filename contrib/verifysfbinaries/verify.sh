...
###   This script attempts to download the signature file SHA256SUMS.asc from qtcoin.org
...
WORKINGDIR="/tmp/qtcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://qtcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://qtcoin.org/bin/"
VERSIONPREFIX="qtcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'qtcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[qtcoin-]<version>-[rc[0-9]] (example: qtcoin-0.9.2-rc1)"
   echo "wget output:"
