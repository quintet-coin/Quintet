The following is a list of assets used in the qtcoin source and their proper attribution.
...
* License: MIT
* Site: [https://qtcointalk.org/index.php?topic=15276.0](https://qtcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original qtcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/qtcoin.icns, src/qt/res/src/qtcoin.svg,
	src/qt/res/src/qtcoin.ico, src/qt/res/src/qtcoin.png,
	src/qt/res/src/qtcoin_testnet.png, docs/qtcoin_logo_doxygen.png,
