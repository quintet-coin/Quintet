...
Intro
-----
QuinTet (QTC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. QuinTet utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run quintet-qt.exe.

QuinTet Core is the original QuinTet client and it builds the backbone of the network.
However, it downloads and stores the entire history of QuinTet transactions;
