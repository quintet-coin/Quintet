...
allowing somebody to distribute a Bitcoin-Qt.app or qtcoin-qt-setup.exe with a valid
...
that the qtcoin-qt.exe file inside the installer had not been tampered with.
