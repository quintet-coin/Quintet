Contributing to QuinTet Core
==================================

The QuinTet Core project operates an open contributor model where anyone is
...
The following applies to code changes to the QuinTet Core project, and is not to be
confused with overall QuinTet Network Protocol consensus changes.

Whether a pull request is merged into QuinTet Core rests with the project merge
...
Patches that change QuinTet consensus rules are considerably more involved than
...
Where a patch set proposes to change the QuinTet consensus, it must have been
...
The project leader is the release manager for each QuinTet Core release.
