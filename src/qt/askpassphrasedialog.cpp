                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    // It doesn't make sense to show the checkbox for sending QTC because you wouldn't check it anyway.
    if (context == Context::Send_QTC)
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("QuinTet will close now to finish the encryption process. "
