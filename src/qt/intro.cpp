...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/qtcoin"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("QuinTet Core"),
     ...
     * override -datadir in the quintet.conf file in the default data directory
     * (to be consistent with quintetd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
