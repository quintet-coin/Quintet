...
#ifndef QTCOIN_QT_QTCOINUNITS_H
#define QTCOIN_QT_QTCOINUNITS_H
...
public:
    ...
    /** QTC units.
      @note Source: https://en.qtcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        QTC,
        mQTC,
