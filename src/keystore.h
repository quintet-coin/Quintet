...
#ifndef QTCOIN_KEYSTORE_H
#define QTCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/qtcoin/bips/blob/master/bip-0013.mediawiki
