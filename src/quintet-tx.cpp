...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QuinTet Core quintet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quintet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quintet transaction") + "\n" +
                               "  quintet-tx [options] -create [commands]   " + _("Create hex-encoded quintet transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quintet transaction
