...
#if defined(NDEBUG)
#error "QuinTet cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uqtc) are considered zero fee (for relaying and mining)
 * We are ~100 times smaller then qtcoin now (2015-06-23), set minRelayTxFee only 10 times higher
