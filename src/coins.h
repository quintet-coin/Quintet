...
#ifndef QTCOIN_COINS_H
#define QTCOIN_COINS_H
...
/**
    ...
    ****Note - for QuinTet we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of quintet coming in to a transaction
