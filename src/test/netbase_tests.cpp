...
{
    BOOST_CHECK(TestSplitHost("www.qtcoin.org", "www.qtcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.qtcoin.org]", "www.qtcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.qtcoin.org:80", "www.qtcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.qtcoin.org]:80", "www.qtcoin.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9222", "::ffff:127.0.0.1", 9222));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9222", "127.0.0.1:9222"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9222", "[::]:9222"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
